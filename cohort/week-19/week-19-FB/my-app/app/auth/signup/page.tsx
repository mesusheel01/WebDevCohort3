...
export default function Signup(){
    ...
    return <div className="h-screen flex justify-center flex-col">
        <div className="flex justify-center">
            <a href="#" className="block max-w-sm p-6 bg-gray-100 border border-gray-200 rounded-lg shadow hover:bg-gray-100">
                <div>
                    <div className=" px-10">
                    ...
                    <div className="pt-2">
                        ...
                        label="Username"
                        placeholder="sush@kyle"
                        />
                        <LabelledInput onChange={(e)=> setPassword(e.target.value)}
                        label="Password"
                        placeholder="ashjo234@#$fdf"
